...
import { Plus, Search, Filter, MoreVertical, FileText, Sparkles, MapPin, DollarSign, Trash2, GraduationCap, Zap } from 'lucide-react';
                ...
                <tr key={job.id} className="hover:bg-slate-50/50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex items-center justify-end gap-2">
                      <button 
                        title="Magic Auto-Pilot (Enhance Resume + Letter)"
